...
namespace Pintureria_Acuarela.Migrations
{
    ...
    [Migration("20231212021715_Seeding")]
            ...
            modelBuilder.Entity("Pintureria_Acuarela.Models.Capacity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 8L,
                            Description = "16 Litros",
                            Volume = 16f
                        },
                        new
                        {
                            ID = 9L,
                            Description = "32 Litros",
                            Volume = 32f
                        },
                        new
                        {
                        ...
                        {
                            ID = 21L,
                            Description = "36 Litros",
                            Volume = 36f
                        },
                        new
                        {
                            ID = 22L,
                            Description = "40 Litros",
                            Volume = 40f
                        },
                        new
                        {
