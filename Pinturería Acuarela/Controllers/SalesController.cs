        ...
        public IActionResult Index()
        {
            try
            {
                ...
                if (_workContainer.ApplicationUser.GetRole(user.Id).Name == Constants.Admin)
                {
                    ...
                    viewModel.Sales = _workContainer.Sale.GetAll(filter, includeProperties: "Products, Products.Product, Products.Product.Capacity, User.Business").OrderByDescending(x => x.CreatedAt);
                }
                else
                {
